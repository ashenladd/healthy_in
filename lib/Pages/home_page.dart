          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Kategori Dokter', style: subTitle.copyWith(fontSize: 16)),
                SizedBox(
                  height: 15,
                ),
                Container(
                        ...
                        child: Column(
                          children: [
                            CircleAvatar(
                              ...
                              child: CircleAvatar(
                                child: ClipOval(
                                    child: Image.asset('assets/Bidan.png')),
                                radius: 29,
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: CircleAvatar(
                                child: ClipOval(
                                    child:
                                        Image.asset('assets/Dokter_Gigi.png')),
                                radius: 29,
                                backgroundColor: blueLightActive,
                              ),
                            ),
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: CircleAvatar(
                                child: ClipOval(
                                    child:
                                        Image.asset('assets/Dokter_THT.png')),
                                radius: 29,
                                backgroundColor: blueLightActive,
                              ),
                            ),
